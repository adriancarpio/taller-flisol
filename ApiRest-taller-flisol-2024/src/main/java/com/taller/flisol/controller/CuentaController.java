...
import com.taller.flisol.service.impl.CuentaServiceImpl;
import com.taller.flisol.util.RespuestaGenerica;
import com.taller.flisol.util.Utils;
...
public class CuentaController {
    ...
    @GetMapping
    public RespuestaGenerica<?> findAll(){        
    	List<CuentaDTO> list = service.findAll().stream().map(util::convertToDtoCuenta).collect(Collectors.toList());
    	return new RespuestaGenerica<>().respuestaExitosa(list, "");
    }
